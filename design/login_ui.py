...
"}")
        ...
        self.btn_minimize.setGeometry(QRect(403, 10, 17, 17))
...
"}")
        ...
        self.frame_error.setGeometry(QRect(10, 40, 441, 30))
...
"border-radius: 5px;")
        ...
        self.label_error.setGeometry(QRect(70, 5, 311, 21))
        ...
        self.close_popup.setGeometry(QRect(415, 7, 17, 17))
...
"}")
        ...
        self.Sign_Up_Pages.setGeometry(QRect(10, 240, 171, 31))
        font1 = QFont()
...
"}")
        ...
        self.label_12.setGeometry(QRect(20, 145, 191, 21))
        self.label_12.setFont(font)
        self.label_12.setStyleSheet(u"color: rgb(93, 93, 93);")
        self.password = QLineEdit(self.centralwidget)
        self.password.setObjectName(u"password")
        self.password.setGeometry(QRect(30, 170, 401, 31))
        font2 = QFont()
...
"}")
        ...
        self.btn_maximize.setGeometry(QRect(376, 10, 17, 17))
...
"}")
        ...
        self.btn_close.setGeometry(QRect(430, 10, 17, 17))
...
"}")
        ...
        self.Username.setGeometry(QRect(30, 105, 401, 31))
